  ...
  {:else if page === 'terms'}
    ...
    <section class="section document-section">
      ...
      <article class="document-copy">
        ...
        <div id="beta"><h2>Beta and backups</h2><p>Sesame is a public beta. It has not completed an independent security review and may change, fail, or be withdrawn. Use test or non-critical data until the release gate is open, keep an independent encrypted backup, and do not rely on Sesame as your only recovery path.</p></div>
